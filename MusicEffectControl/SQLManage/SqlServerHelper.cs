   ...
   public class SqlServerHelper
    {
            ...
            public static string SetSqlServerConnectStr(string serveraddress, string dbname, int port, string username, string password)
            {
                string atv = "Server={0};Database={1};User Id={2};Password = {3}; ";
                return string.Format(atv, serveraddress,dbname, username, password);
            }
            /// <summary>
            /// 设置参数内容
            /// </summary>
            ...
            /// <returns></returns>
            public SqlParameter SetDataParameter(string ParamName, SqlDbType DbType, Int32 Size, object paramevalue, ParameterDirection Direction)
            {
            ...
            /// <param name="Direction">类型</param>
            /// <returns></returns>
            public SqlParameter SetDataParameter(string ParamName, SqlDbType DbType, ParameterDirection Direction)
            {
                SqlParameter param = new SqlParameter();
                param.SqlDbType = DbType;
                param.ParameterName = ParamName;
            ...
            private void PrepareCommand(SqlConnection Connection, SqlCommand Command, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
            {
                try
                {
                    if (Command == null) throw new ArgumentNullException("command");
            ...
            /// <returns>返回一个包含结果集的DataSet</returns>
            public DataSet ExecuteDataSet(SqlTransaction transaction, string commandText, CommandType commandType, params SqlParameter[] commandParameters)
            {
            ...
            /// <returns>返回一个包含结果集的DataSet</returns>
            public DataSet ExecuteDataSet(string commandText, CommandType commandTytpe)
            {
            ...
            /// <param name="commandParameters">参数</param>
            /// <returns>返回一个包含结果集的DataSet</returns>
            public DataSet ExecuteDataSet(ref Hashtable outParameters, string commandText, CommandType commandType, params SqlParameter[] commandParameters)
            {
                if (SqlConnectionString == null || SqlConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
            ...
            /// <param name="commandParameters">参数</param>
            /// <returns>返回一个包含结果集的DataSet</returns>
            public DataSet ExecuteDataSet(ref Hashtable outParameters, string SqlSPro, params SqlParameter[] commandParameters)
            {
            ...
            /// <param name="commandParameters">参数</param>
            /// <returns>返回一个包含结果集的DataSet</returns>
            public DataSet ExecuteDataSet(string SqlSPro, params SqlParameter[] commandParameters)
            {
            ...
            public DbDataReader ExecuteDataReader(SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
            {
            ...
            public DbDataReader ExecuteDataReader(SqlTransaction transaction, CommandType commandType, string commandText)
            {
                if (SqlConnectionString == null || SqlConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
            ...
            public DbDataReader ExecuteDataReader(CommandType commandType, string commandText, params SqlParameter[] commandParameters)
            {
                if (SqlConnectionString == null || SqlConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
                SqlConnection connection = null;
                try
            ...
            public DbDataReader ExecuteDataReader(SqlConnection connection, out List<string[]> outParameters, string commandText, CommandType commandType, params SqlParameter[] commandParameters)
            {
                DbDataReader reader = null;
            ...
            public DbDataReader ExecuteDataReader(out List<string[]> outParameters, string SqlSPro, params SqlParameter[] commandParameters)
            {
                if (SqlConnectionString == null || SqlConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
                SqlConnection connection = null;
                try
            ...
            public DataRow ExecuteDataRow(SqlTransaction transaction, string commandText, CommandType commandType, params SqlParameter[] commandParameters)
            {
                try
                {
                    DataRow row = null;
            ...
            public DataRow ExecuteDataRow(string commandText, CommandType commandType, params SqlParameter[] commandParameters)
            {
            ...
            public int ExecuteNonQuery(ref Hashtable OutPut, string commandText, params SqlParameter[] commandParameters)
            {
            ...
            public void CopyExecutNonQuery(string TableName, DataTable dt)
            {
                if (SqlConnectionString == null || SqlConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
                using (SqlConnection connection = new SqlConnection(SqlConnectionString))
                {
            ...
            public int ExecuteNonQuery(out int Scope_Identity, SqlTransaction Transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
            {
                Scope_Identity = 0;
            ...
            /// <param name="commandParameters">SqlParamter参数数组</param>
            /// <returns>返回影响的行数</returns>
            public int ExecuteNonQuery(out int Scope_Identity, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
            {
            ...
            public List<string[]> ExecuteNonQuery(string commandText, CommandType commandType, params SqlParameter[] commandParameters)
            {
                if (SqlConnectionString == null || SqlConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
